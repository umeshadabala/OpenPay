    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-radial-[at_top] from-slate-900 via-slate-950 to-slate-950">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-xl font-bold text-white mb-6">Create your developer account</h2>

          {error && (
            <div className="bg-red-500/15 border border-red-500/30 text-red-200 text-sm rounded-xl p-4 mb-6 flex items-start gap-2">
          ...
          <div className="mt-8 text-center border-t border-slate-800/60 pt-6">
            <p className="text-slate-400 text-sm">
              ...
              <Link href="/login" className="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors duration-200">
                Log in
              </Link>
            </p>
          </div>
