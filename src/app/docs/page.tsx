...
export default function DocsPage({ isDashboard = false }: DocsPageProps) {
...
async def openpay_webhook(request: Request, x_openpay_signature: str = Header(None)):
  ...
  const mainContent = (
    <div className="space-y-12">
      {/* Tabs Navigation */}
      <div className="flex border-b border-neutral-900 overflow-x-auto gap-2 no-scrollbar">
        {tabs.map((tab) => {
          const Icon = tab.icon;
      ...
      <div className="space-y-12">
        ...
        {activeTab === 'quickstart' && (
          <div className="space-y-8 animate-fadeIn text-neutral-350">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 bg-neutral-900/30 border border-neutral-900 p-5 rounded-2xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-neutral-450 leading-relaxed">
                    Set up your business identifiers in the <Link href="/dashboard/profile" className="text-indigo-400 hover:underline">Profile</Link> tab. Provide your Merchant Name and Payee VPA (UPI ID). This determines where users send transactions.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-neutral-900/30 border border-neutral-900 p-5 rounded-2xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-neutral-450 leading-relaxed">
                    Configure your destination webhook endpoint in the <Link href="/dashboard/webhooks" className="text-indigo-400 hover:underline">Webhooks</Link> tab. Copy the generated signing secret to verify incoming HTTP calls.
                  </p>
                </div>
              </div>
            </div>
...
<uses-permission android:name="android.permission.INTERNET" />`}
              ...
              <div className="bg-neutral-900/20 border border-neutral-900 rounded-xl p-5 space-y-3">
                ...
                <div className="text-xs text-neutral-400 space-y-1.5 mt-1 bg-neutral-950/40 p-3 rounded-lg border border-neutral-900">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-neutral-900/20 border border-neutral-900 rounded-xl p-5 space-y-3">
                ...
                <p className="text-xs text-neutral-450">
                  The payload fired to your configured destination URL when a verified credit transaction is attributed by the AI engine.
                </p>
...
{`{
              ...
              <ul className="list-disc pl-5 text-xs text-neutral-400 space-y-2">
                ...
                <li>
                  ...
                  <div className="bg-neutral-950 p-3 border border-neutral-900 rounded-lg mt-1 font-mono text-neutral-400 grid grid-cols-3 gap-2">
                    ...
                    <div className="text-indigo-400 font-semibold">Net Expected: ₹99.94</div>
                  </div>
                </li>
                <li>
  ...
  // If inside the Dashboard Console layout
  if (isDashboard) {
    return (
      <div className="space-y-8 max-w-5xl">
        <div>
          ...
          <p className="text-neutral-400 text-sm mt-1">
            Complete technical guide for OpenPay architecture and API configuration.
          </p>
        </div>
        {mainContent}
      </div>
  ...
  // If accessed via the public /docs route
  return (
    <div className="flex-1 flex flex-col bg-slate-950 text-slate-100 min-h-screen">
      {/* Background Gradients */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[500px] bg-radial-[at_top] from-indigo-500/10 via-blue-500/5 to-transparent -z-10 blur-3xl" />

      {/* Header */}
      <header className="max-w-6xl mx-auto w-full px-6 h-20 flex items-center justify-between border-b border-neutral-900/50">
        ...
        <nav className="flex items-center gap-4">
          <Link href="/" className="text-sm text-slate-400 hover:text-white transition-all font-semibold flex items-center gap-1.5">
            <ArrowLeft size={14} />
            Back to Home
          </Link>
          <Link href="/login" className="text-sm bg-slate-900 border border-slate-800 hover:bg-slate-800 text-white px-4 py-2 rounded-xl transition-all font-semibold">
            Console Sign In
          </Link>
        </nav>
      </header>
      ...
      <main className="max-w-6xl mx-auto w-full px-6 py-12 flex-1">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-white mt-1.5 tracking-tight">OpenPay Developer Portal</h1>
